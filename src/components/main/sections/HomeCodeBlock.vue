...
<template>
    <p class="main">
        ...
        <span class="code-violet"> main()</span> {</p>
    <p class="intent-L1">
        lis, err <span class="code-blue">:= </span>
        net.<span class="code-violet">Listen</span>(
        <span class="code-blue">"tcp"</span>, 
        <span class="code-blue">"localhost:5400"</span>)
    </p>
    <p class="intent-L1">
        <span class="code-orange">if</span> err 
        <span class="code-blue">! = nil</span> {
    </p>
    <p class="intent-L2">
    ...
    <p class="intent-L1">}</p>
    <p class="intent-L1">
        <span class="code-orange">var</span> opts []grpc.ServerOption
    </p>
    <p class="intent-L1">
        grpcServer 
    ...
    <p class="intent-L2">
        channel:    <span class="code-violet">make</span>
        (<span class="code-orange">map</span>[string][]
